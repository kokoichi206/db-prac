...
----------------------------------------+--------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------
 ...
 effective_cache_size                   | 48MB                                       | Sets the planner's assumption about the total size of the data caches.
 ...
 maintenance_work_mem                   | 4MB                                        | Sets the maximum memory to be used for maintenance operations.
 ...
 max_wal_size                           | 4GB                                        | Sets the WAL size that triggers a checkpoint.
 ...
 server_version                         | 15.2                                       | Shows the server version.
 server_version_num                     | 150002                                     | Shows the server version as an integer.
 ...
 shared_buffers                         | 16MB                                       | Sets the number of shared memory buffers used by the server.
 shared_memory_size                     | 29MB                                       | Shows the size of the server's main shared memory area (rounded up to the nearest MB).
 shared_memory_size_in_huge_pages       | 15                                         | Shows the number of huge pages needed for the main shared memory area.
 ...
 wal_buffers                            | 488kB                                      | Sets the number of disk-page buffers in shared memory for WAL.
 ...
 work_mem                               | 64kB                                       | Sets the maximum memory to be used for query workspaces.
